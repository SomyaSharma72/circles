...
export const RequestCard: React.FC<RequestCardProps> = ({ request, explanation }) => {
  ...
  } as Record<string, {label:string;variant:string}>;

  const currentUrgency = urgencyVariants[(request as any).urgency] || urgencyVariants.medium;
      ...
      <div>
        <div className="flex items-center justify-between gap-2 mb-3 flex-wrap">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Badge variant={currentUrgency.variant as any}>{currentUrgency.label}</Badge>
          </div>
